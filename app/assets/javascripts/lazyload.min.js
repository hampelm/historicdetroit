...
!(function(e, t) {
  ...
  function t(e, t, n) {
    (!n && a(e)) ||
      ...
      ["IMG", "IFRAME", "VIDEO"].indexOf(e.tagName) > -1 &&
        (y(e, t), m(e, t.class_loading)),
      u(e, t),
      o(e),
      h(t.callback_set, e));
  }
  var n = function(e) {
    ...
    u = function(e, t) {
      ...
      switch (e.tagName) {
        case "IMG":
          var i = e.parentNode;
          i && "PICTURE" === i.tagName && c(i, "srcset", s);
          var u = r(e, n);
          l(e, "sizes", u);
          var d = r(e, s);
          l(e, "srcset", d), l(e, "src", a);
          break;
        case "IFRAME":
          l(e, "src", a);
          break;
    ...
    g = function(e, t, n) {
      var r = e.target;
      b(r, n.class_loading),
        m(r, t ? n.class_loaded : n.class_error),
        h(t ? n.callback_load : n.callback_error, r);
    },
    E = function(e) {
  ...
  return (
    (L.prototype = {
      ...
      update: function(t) {
        var n = this,
          r = this._settings,
          s = t || r.container.querySelectorAll(r.elements_selector);
        (this._elements = e(Array.prototype.slice.call(s))),
          !f && this._observer
            ? this._elements.forEach(function(e) {
